...
Shop:AddButton({
    Title = "Buy 2x EXP (15 mins.) < 50 Candies >",
    function()
        FireRemote("Candies", "Check")
        FireRemote("Candies", "Buy", 1, 1)
    end
})
Shop:AddButton({
    Title = "Stats Refund < 75 Candies >",
    function()
        FireRemote("Candies", "Check")
...
Shop:AddSection("")
Shop:AddButton({
    Title = "Buy 200 Frags < 50 Candies >",
    function()
        FireRemote("Candies", "Check")
...
Shop:AddButton({
    Title = "Buy 500 Frags < 100 Candies >",
    function()
        FireRemote("Candies", "Check")
...
Shop:AddButton({
    Title = "Buy Surprise < 50 Bones >",
    function()
        FireRemote("Bones", "Buy", 1, 1)
    end
})
Shop:AddButton({
    Title = "Stats Refund < 150 Bones >",
    function()
        FireRemote("Bones", "Buy", 1, 2)
    end
})
Shop:AddButton({
    Title = "Race Reroll < 300 Bones >",
    function()
...
Shop:AddButton({
    ...
    function()
        -- Add your Midnight Blade logic here
    end
})
Shop:AddButton({
    Title = "Bizarre Rifle",
    function()
        -- Add your Bizarre Rifle logic here
    end
})
